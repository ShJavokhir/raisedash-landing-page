...
A checklist is only useful if the team can see ownership and status. [Raisedash Orientation](/products/orientation) handles the online part of the workflow: send orientation by text or email, let drivers complete videos, readings, and quizzes in a phone browser, follow progress, and download the available training report.
