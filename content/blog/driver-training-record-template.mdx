...
[Raisedash Orientation](/products/orientation) records online training activity while the driver completes the work. The current PDF report includes a driver summary, assigned training, completion details, quiz attempts and scores, recorded activity, and certificates available in Raisedash.
