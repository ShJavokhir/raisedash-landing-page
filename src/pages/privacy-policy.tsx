          ...
          <div className="prose prose-slate dark:prose-invert mx-auto max-w-4xl">
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                operating our platform, conducting business, or serving our users. These parties
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                countries, we use standard contractual clauses and other appropriate safeguards to
            ...
            <section className="mb-12">
              ...
              <div className="bg-muted rounded-lg p-6">
                ...
                <p className="text-muted-foreground mb-2">
                  General Inquiries: support@raisedash.com
                </p>
                <p className="text-muted-foreground">
