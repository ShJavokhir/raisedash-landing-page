...
const STATIC_PAGE_DATES: Record<string, string> = {
  ...
  "/features": "2026-07-19",
  "/features/ai-training-video-generator": "2026-07-19",
  "/features/ai-training-program-builder": "2026-07-19",
...
function generateSiteMap(
  ...
  const staticPages = [
    ...
    },
    {
      ...
      lastmod: STATIC_PAGE_DATES["/features"],
      changefreq: "weekly",
      priority: "0.9",
    },
    {
      loc: `${SITE_URL}/features/ai-training-video-generator`,
      lastmod: STATIC_PAGE_DATES["/features/ai-training-video-generator"],
      changefreq: "weekly",
      priority: "0.9",
    },
    {
      loc: `${SITE_URL}/features/ai-training-program-builder`,
      lastmod: STATIC_PAGE_DATES["/features/ai-training-program-builder"],
      changefreq: "weekly",
      priority: "0.9",
    },
    {
      loc: `${SITE_URL}/features/ai-voice-roleplay-training`,
      lastmod: STATIC_PAGE_DATES["/features/ai-voice-roleplay-training"],
      changefreq: "weekly",
      priority: "0.9",
    },
    {
      loc: `${SITE_URL}/features/interactive-training-simulations`,
      lastmod: STATIC_PAGE_DATES["/features/interactive-training-simulations"],
      changefreq: "weekly",
      priority: "0.9",
    },
    {
