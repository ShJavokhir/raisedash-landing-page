        ...
        <div className="py-16">
          <div className="max-w-4xl mx-auto prose prose-slate dark:prose-invert">
            <section className="mb-12">
              ...
              <div className="bg-muted rounded-lg p-6 mt-6">
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2">
                  ...
                  <li>
                    <strong>Secure Infrastructure:</strong> AWS-based secure hosting
                  </li>
                  <li>
                    <strong>Access Controls:</strong> Strong authentication and authorization
                  </li>
                  <li>
                    <strong>Regular Updates:</strong> Keeping systems and dependencies current
                  </li>
                  <li>
                    <strong>Security Monitoring:</strong> Basic monitoring and alerting in place
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                Our platform is built on Amazon Web Services (AWS), leveraging their secure
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>
                  <strong>Security Groups:</strong> Firewall rules for application access
                </li>
                <li>
                  <strong>SSL/TLS:</strong> Encrypted connections for all traffic
                </li>
                <li>
                  <strong>AWS KMS:</strong> Encryption key management
                </li>
                <li>
                  <strong>CloudTrail:</strong> Basic logging and monitoring
                </li>
              </ul>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>
                  <strong>AES-256:</strong> Database and file encryption at rest
                </li>
                <li>
                  <strong>HTTPS Everywhere:</strong> Secure web connections
                </li>
                <li>
                  <strong>Secure APIs:</strong> All API endpoints use encryption
                </li>
              </ul>
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                We implement strong access controls to ensure only authorized users can access your
                data.
              </p>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>
                  <strong>Email Verification:</strong> Account verification required
                </li>
                <li>
                  <strong>Session Management:</strong> Secure session handling with timeouts
                </li>
                <li>
                  <strong>Password Reset:</strong> Secure password recovery process
                </li>
              </ul>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>
                  <strong>Error Monitoring:</strong> Tracking of application errors and anomalies
                </li>
                <li>
                  <strong>Uptime Monitoring:</strong> Service availability tracking
                </li>
                <li>
                  <strong>Basic Alerts:</strong> Notification of critical security events
                </li>
              </ul>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>
                  <strong>Dependency Scanning:</strong> Automated scanning for vulnerable
                  dependencies
                </li>
                <li>
                  <strong>Basic Penetration Testing:</strong> Internal security assessments
                </li>
                <li>
                  <strong>Security Updates:</strong> Regular updates and patches
                </li>
              </ul>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>
                  <strong>Encrypted Storage:</strong> All backups encrypted and stored securely
                </li>
                <li>
                  <strong>Multiple Locations:</strong> Backups stored in separate AWS regions
                </li>
                <li>
                  <strong>Retention Policy:</strong> 30-day backup retention
                </li>
              </ul>
