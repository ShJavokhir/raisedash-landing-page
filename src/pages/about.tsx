  ...
  return (
    ...
    >
      ...
      <Container className="py-12 md:px-0">
        <div className="bg-card rounded-xs border border-border p-8 sm:p-12 animate-fade-in-scale delay-200">
      ...
      <Container className="py-12 md:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="bg-card rounded-xs border border-border p-6 transition-all duration-[0.15s] hover:-translate-y-0.5 hover:bg-surface-2 animate-fade-in-scale delay-400">
          ...
          <div className="bg-card rounded-xs border border-border p-6 transition-all duration-[0.15s] hover:-translate-y-0.5 hover:bg-surface-2 animate-fade-in-scale delay-500">
          ...
          <div className="bg-card rounded-xs border border-border p-6 transition-all duration-[0.15s] hover:-translate-y-0.5 hover:bg-surface-2 animate-fade-in-scale delay-600">
