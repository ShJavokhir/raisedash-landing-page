    ...
    <>
      ...
      <Container>
        <div className="mx-auto max-w-xl py-20">
          <h1 className="mb-4 text-3xl font-bold">Unsubscribe</h1>
          {status === "confirm" && (
            <div className="space-y-6">
              <p className="text-muted-foreground">
                {email ? (
                  <span>
                    You are about to unsubscribe the email{" "}
                    <span className="font-medium">{email}</span> from future emails.
                  </span>
                ) : (
              ...
              <div className="flex gap-3">
                <Button onClick={onConfirm}>Yes, unsubscribe me</Button>
          ...
          {status === "submitting" && <p>Processing your request…</p>}

          {status === "success" && (
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold">You have been unsubscribed</h2>
              <p className="text-muted-foreground">
                We have recorded your preference. You won’t receive further emails.
              </p>
              <Button variant="secondary" onClick={() => router.push("/")}>
                Go back home
              </Button>
