          ...
          <div className="prose prose-slate dark:prose-invert mx-auto max-w-4xl">
            <section className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                By accessing and using Raisedash ("the Service"), you accept and agree to be bound
                by the terms and provision of this agreement. If you do not agree to abide by the
                above, please do not use this service.
              </p>
              <p className="text-muted-foreground">
                These Terms of Use ("Terms") govern your use of our website located at raisedash.com
                (the "Service") operated by LoadHunter Inc., doing business as Raisedash ("us",
                "we", or "our").
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                remain the exclusive property of LoadHunter Inc. and its licensors. The Service is
                protected by copyright, trademark, and other laws.
              </p>
              <p className="text-muted-foreground">
                You may not reproduce, distribute, modify, create derivative works of, publicly
                display, publicly perform, republish, download, store, or transmit any of our
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                Service will be available at all times. We may experience downtime for maintenance,
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground">
                You agree to defend, indemnify, and hold harmless LoadHunter Inc. and its licensee
