            ...
            <div className="flex flex-wrap gap-2">
              {categories.map((category) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-normal transition-all duration-[0.15s] ${
                    selectedCategory === category
                      ? "bg-primary text-primary-foreground"
                      : "bg-background text-foreground border border-border hover:bg-surface-2 hover:text-foreground-80"
                  }`}
                >
                  {category}
                </button>
        ...
        <Container>
          {filteredPosts.length > 0 ? (
            ...
            <div className="bg-white rounded-xs border border-border p-12 text-center">
              ...
              <h3 className="text-xl font-normal text-foreground mb-2">No articles found</h3>
      ...
      <section className="bg-background border-t border-border py-16 md:py-20">
        <Container>
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-[28px] font-normal tracking-[-0.03em] text-foreground mb-4">
              Stay Updated
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto">
              <input
                ...
                className="flex-1 h-11 px-4 rounded-xs border border-border bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-foreground-40 transition-colors duration-[0.15s]"
              />
